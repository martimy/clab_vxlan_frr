...
docker exec -it clab-pim-r1 ip link add vxlan100 type vxlan id 100 dstport 4789 local 1.1.1.1 group 239.1.1.1 dev eth1
...
docker exec -it clab-pim-r2 ip link add vxlan100 type vxlan id 100 dstport 4789 local 1.1.1.2 group 239.1.1.1 dev eth1
...
docker exec -it clab-pim-r3 ip link add vxlan100 type vxlan id 100 dstport 4789 local 1.1.1.3 group 239.1.1.1 dev eth1
