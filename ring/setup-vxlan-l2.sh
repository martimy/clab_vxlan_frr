...
docker exec -it clab-ring-r1 ip link add vxlan100 type vxlan id 100 dstport 4789 local 1.1.1.1 nolearning
...
docker exec -it clab-ring-r2 ip link add vxlan100 type vxlan id 100 dstport 4789 local 1.1.1.2 nolearning
...
docker exec -it clab-ring-r3 ip link add vxlan100 type vxlan id 100 dstport 4789 local 1.1.1.3 nolearning
